...
import com.idas.springbootinit.annotation.AuthCheck;
import com.idas.springbootinit.bizmq.MessageProducer;
import com.idas.springbootinit.common.BaseResponse;
import com.idas.springbootinit.common.DeleteRequest;
...
import com.idas.springbootinit.constant.UserConstant;
import com.idas.springbootinit.exception.BusinessException;
import com.idas.springbootinit.exception.ThrowUtils;
import com.idas.springbootinit.manager.AiManager;
import com.idas.springbootinit.manager.OpenAiManager;
import com.idas.springbootinit.manager.RedisLimiterManager;
import com.idas.springbootinit.model.dto.chart.*;
...
import com.idas.springbootinit.utils.ExcelUtils;
import com.idas.springbootinit.utils.SqlUtils;
...
public class ChartController {
    ...
    public BaseResponse<BiResponse> genChartByAi(@RequestPart("file") MultipartFile multipartFile,
        ...
        ThrowUtils.throwIf(StringUtils.isNotBlank(goal) && goal.length() > 100, ErrorCode.PARAMS_ERROR, "目标过长");
        ...
        ThrowUtils.throwIf(size > 5 * ONE_MB, ErrorCode.PARAMS_ERROR, "文件过大");
        String suffix = FileUtil.getSuffix(originalFilename);
        final List<String> ALLOWED_EXTENSIONS = Arrays.asList("xls", "xlsx");
        ThrowUtils.throwIf(!ALLOWED_EXTENSIONS.contains(suffix),
        ...
        // 业务逻辑移动到 service 层
        BiResponse biResponse = chartService.genChartUsingAi(name, chartType, multipartFile, name, goal, loginUser);
    ...
    public BaseResponse<BiResponse> genChartByAiAsyncMq(@RequestPart("file") MultipartFile multipartFile,
        ...
        // 插入到数据库,并向消息队列发送消息，并向前端返回插入数据库成功的消息
        ...
        // 业务逻辑移动到 service 层,并且在消息队列里调用service层代码
//        chartService.genChartUsingAiAsyncMq(newChartId);
